...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/long-star-75e1)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/long-star-75e1
```

A live public deployment of this template is available at [https://long-star-75e1.templates.workers.dev](https://long-star-75e1.templates.workers.dev)
